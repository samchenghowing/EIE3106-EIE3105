...
int main(void){
	...
	while(1){
			...
			{	
				...
				//ball2
				carSlope =((float)carBackY-carY)/(carBackX-carX);
				slope =((float)carBackY-Ball2Y)/(carBackX-Ball2X);
				carAngle = atan(carSlope)*180/(3.1415);
				ballAngle = atan(slope)*180/(3.1415);
				TIM3->CCR1 = 1500;
				TIM3->CCR2 = 1500;
				...
				//ball3
				carSlope =((float)carBackY-carY)/(carBackX-carX);
				slope =((float)carBackY-Ball3Y)/(carBackX-Ball3X);
				carAngle = atan(carSlope)*180/(3.1415);
				ballAngle = atan(slope)*180/(3.1415);
				TIM3->CCR1 = 1500;
				TIM3->CCR2 = 1500;
	...
	for(int i=0;i<validPacketSize;i++){
		...
		if(wifiValidData[i]=='\n'){
			...
			if(Pos1[0]=='B' && Pos1[1]=='B' && Pos1[2]=='E'){
				Ball2X = hex2int(Pos1[3])*16*16 + hex2int(Pos1[4])*16 + hex2int(Pos1[5]);
				Ball2Y = hex2int(Pos1[6])*16*16 + hex2int(Pos1[7])*16 + hex2int(Pos1[8]);			
			}
			if(Pos1[0]=='B' && Pos1[1]=='B' && Pos1[2]=='Y'){
				Ball3X = hex2int(Pos1[3])*16*16 + hex2int(Pos1[4])*16 + hex2int(Pos1[5]);
				Ball3Y = hex2int(Pos1[6])*16*16 + hex2int(Pos1[7])*16 + hex2int(Pos1[8]);			
			}	
			for(j=0;j<10;j++){
				Pos1[j]='\0';	
			}
